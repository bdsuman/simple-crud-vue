<template>
    ...
    >
        <div
            class="notification-modal error-modal"
            @mouseenter="pauseTimer"
            @mouseleave="resumeTimer"
        >
            <div class="notification flex justify-between">
                <div class="body flex gap-3 items-center">
                    <div class="p-1.5 bg-[#E73238] rounded-3xl">
                        <FailedIcon />
                    </div>
                    <div class="flex flex-col">
                        <p
                            class="notification-title"
                            v-trans="params.title ?? 'Unsuccessful!'"
                        ></p>
                        <p
...
import FailedIcon from "@/components/icons/modal/FailedIcon.vue";
...
.error-modal {
    filter: drop-shadow(4px 0px 0px #e73238);
